...
// {EC1CC9CE-FAED-4822-828A-828D1A7A018F}  UI CPL wrapper
const GUID EQUALIZERAPO_UI_CPL_GUID = {0xec1cc9ce, 0xfaed, 0x4822, {0x82, 0x8a, 0x82, 0x8d, 0x1a, 0x7a, 0x01, 0x8f}};
